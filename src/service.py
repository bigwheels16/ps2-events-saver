...
class Service:
    def insert_player_login_event(self, character_id, world_id, timestamp):
    ...
    def insert_player_logout_event(self, character_id, world_id, timestamp):
    ...
    def insert_gain_experience_event(self, amount, loadout_id, experience_id, other_id, character_id, zone_id, world_id, timestamp):
    ...
    def insert_death_event(self, is_headshot, attacker_loadout_id, attacker_fire_mode_id, attacker_weapon_id, attacker_vehicle_id, attacker_character_id, character_loadout_id, character_id, zone_id, world_id, timestamp):
    ...
    def insert_facility_defend_event(self, character_id, outfit_id, facility_id, zone_id, world_id, timestamp):
    ...
    def insert_facility_capture_event(self, character_id, outfit_id, facility_id, zone_id, world_id, timestamp):
    ...
    def insert_facility_control_event(self, duration_held, facility_id, old_faction_id, new_faction_id, outfit_id, zone_id, world_id, timestamp):
